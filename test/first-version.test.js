...
describe('first-version', function () {
  ...
  it('fv-works', function(){
    ...
    expect(j('"--foo--":1, bar:zed')).toEqual( {"--foo--":1,"bar":"zed"} )
    expect(j('"--foo":1, bar:zed')).toEqual( {"--foo":1,"bar":"zed"} )
    expect(j('"foo--bar-baz":1, "-bar":zed')).toEqual( {"foo--bar-baz":1,"-bar":"zed"} )
    expect(j('"foo--":1, bar:zed')).toEqual( {"foo--":1,"bar":"zed"} )
  ...
  it('fv-numbers', function(){
    expect(j("x:0,a:102,b:1.2,c:-3,d:-4.5,e:-10")).toEqual({"x":0,"a":102,"b":1.2,"c":-3,"d":-4.5,"e":-10})

    expect(j("x:0,a:102,b:1.2,c:1e2,d:1.2e3,e:1e+2,f:1e-2,g:1.2e+3,h:1.2e-3,i:-1.2e+3,j:-1.2e-3")).toEqual({"x":0,"a":102,"b":1.2,"c":100,"d":1200,"e":100,"f":0.01,"g":1200,"h":0.0012,"i":-1200,"j":-0.0012})
    ...
    expect(j("x:01,a:1a,b:10b,c:1e2e")).toEqual({"x":1,"a":"1a","b":"10b","c":"1e2e"})
  })
