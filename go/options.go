...
// mergeOptions deep-merges src into dst, matching the TypeScript deep() behavior.
// nil/zero fields in src do not overwrite existing values in dst.
func mergeOptions(dst, src *Options) {
	...
	if src.Fixed != nil {
		if dst.Fixed == nil {
			...
			if src.Fixed.Lex != nil {
				dst.Fixed.Lex = src.Fixed.Lex
			}
		}
	}
	if src.Space != nil {
		if dst.Space == nil {
			...
			if src.Space.Lex != nil {
				dst.Space.Lex = src.Space.Lex
			}
			if src.Space.Chars != "" {
				dst.Space.Chars = src.Space.Chars
			}
		}
	}
	if src.Line != nil {
		if dst.Line == nil {
			...
			if src.Line.Lex != nil {
				dst.Line.Lex = src.Line.Lex
			}
			if src.Line.Chars != "" {
				dst.Line.Chars = src.Line.Chars
			}
			if src.Line.RowChars != "" {
				dst.Line.RowChars = src.Line.RowChars
			}
			if src.Line.Single != nil {
				dst.Line.Single = src.Line.Single
			}
		}
	}
	if src.Text != nil {
		if dst.Text == nil {
			...
			if src.Text.Lex != nil {
				dst.Text.Lex = src.Text.Lex
			}
			if len(src.Text.Modify) > 0 {
				dst.Text.Modify = src.Text.Modify
			}
		}
	}
	if src.Number != nil {
		if dst.Number == nil {
			...
			if src.Number.Lex != nil {
				dst.Number.Lex = src.Number.Lex
			}
			if src.Number.Hex != nil {
				dst.Number.Hex = src.Number.Hex
			}
			if src.Number.Oct != nil {
				dst.Number.Oct = src.Number.Oct
			}
			if src.Number.Bin != nil {
				dst.Number.Bin = src.Number.Bin
			}
			if src.Number.Sep != "" {
				dst.Number.Sep = src.Number.Sep
			}
			if src.Number.Exclude != nil {
				dst.Number.Exclude = src.Number.Exclude
			}
		}
	}
	if src.Comment != nil {
		if dst.Comment == nil {
			...
			if src.Comment.Lex != nil {
				dst.Comment.Lex = src.Comment.Lex
			}
			if src.Comment.Def != nil {
				if dst.Comment.Def == nil {
					dst.Comment.Def = make(map[string]*CommentDef)
				}
				for k, v := range src.Comment.Def {
					dst.Comment.Def[k] = v
				}
			}
		}
	...
	if src.String != nil {
		if dst.String == nil {
			...
			if src.String.Lex != nil {
				dst.String.Lex = src.String.Lex
			}
			if src.String.Chars != "" {
				dst.String.Chars = src.String.Chars
			}
			if src.String.MultiChars != "" {
				dst.String.MultiChars = src.String.MultiChars
			}
			if src.String.EscapeChar != "" {
				dst.String.EscapeChar = src.String.EscapeChar
			}
			if src.String.Escape != nil {
				if dst.String.Escape == nil {
					dst.String.Escape = make(map[string]string)
				}
				for k, v := range src.String.Escape {
					dst.String.Escape[k] = v
				}
			}
			if src.String.AllowUnknown != nil {
				dst.String.AllowUnknown = src.String.AllowUnknown
			}
			if src.String.Abandon != nil {
				dst.String.Abandon = src.String.Abandon
			}
			if src.String.Replace != nil {
				if dst.String.Replace == nil {
					dst.String.Replace = make(map[rune]string)
				}
				for k, v := range src.String.Replace {
					dst.String.Replace[k] = v
				}
			}
		}
	}
	if src.Map != nil {
		if dst.Map == nil {
			...
			if src.Map.Extend != nil {
				dst.Map.Extend = src.Map.Extend
			}
			if src.Map.Child != nil {
				dst.Map.Child = src.Map.Child
			}
			if src.Map.Merge != nil {
				dst.Map.Merge = src.Map.Merge
			}
		}
	}
	if src.List != nil {
		if dst.List == nil {
			...
			if src.List.Property != nil {
				dst.List.Property = src.List.Property
			}
			if src.List.Pair != nil {
				dst.List.Pair = src.List.Pair
			}
			if src.List.Child != nil {
				dst.List.Child = src.List.Child
			}
		}
	}
	if src.Value != nil {
		if dst.Value == nil {
			...
			if src.Value.Lex != nil {
				dst.Value.Lex = src.Value.Lex
			}
			if src.Value.Def != nil {
				if dst.Value.Def == nil {
					dst.Value.Def = make(map[string]*ValueDef)
				}
				for k, v := range src.Value.Def {
					dst.Value.Def[k] = v
				}
			}
		}
	...
	if src.Rule != nil {
		if dst.Rule == nil {
			...
			if src.Rule.Start != "" {
				dst.Rule.Start = src.Rule.Start
			}
			if src.Rule.Finish != nil {
				dst.Rule.Finish = src.Rule.Finish
			}
			if src.Rule.MaxMul != nil {
				dst.Rule.MaxMul = src.Rule.MaxMul
			}
			if src.Rule.Exclude != "" {
				dst.Rule.Exclude = src.Rule.Exclude
			}
		}
	}
	if src.Lex != nil {
		if dst.Lex == nil {
			...
			if src.Lex.Empty != nil {
				dst.Lex.Empty = src.Lex.Empty
			}
			if src.Lex.EmptyResult != nil {
				dst.Lex.EmptyResult = src.Lex.EmptyResult
			}
			if src.Lex.Match != nil {
				if dst.Lex.Match == nil {
					dst.Lex.Match = make(map[string]*MatchSpec)
				}
				for k, v := range src.Lex.Match {
					dst.Lex.Match[k] = v
				}
			}
		}
	...
	if src.Parser != nil {
		if dst.Parser == nil {
			...
			if src.Parser.Start != nil {
				dst.Parser.Start = src.Parser.Start
			}
		}
	}
	if src.Error != nil {
		if dst.Error == nil {
			dst.Error = make(map[string]string)
		}
		for k, v := range src.Error {
			dst.Error[k] = v
		}
	}
	if src.Hint != nil {
		if dst.Hint == nil {
			dst.Hint = make(map[string]string)
		}
		for k, v := range src.Hint {
			dst.Hint[k] = v
		}
	}
	if src.Property != nil {
		if dst.Property == nil {
			...
			if src.Property.ConfigModify != nil {
				if dst.Property.ConfigModify == nil {
					dst.Property.ConfigModify = make(map[string]ConfigModifier)
				}
				for k, v := range src.Property.ConfigModify {
					dst.Property.ConfigModify[k] = v
				}
			}
			if src.Property.TextInfo != nil {
				dst.Property.TextInfo = src.Property.TextInfo
			}
			if src.Property.ListRef != nil {
				dst.Property.ListRef = src.Property.ListRef
			}
			if src.Property.MapRef != nil {
				dst.Property.MapRef = src.Property.MapRef
			}
		}
	}
	if src.Tag != "" {
