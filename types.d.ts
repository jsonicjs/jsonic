...
export declare type JsonicParse = (
  src: any,
  meta?: any,
  parent_ctx?: any
) => any
...
export declare type RuleDefiner = (
  rs: RuleSpec,
  rsm: RuleSpecMap
) => void | RuleSpec
...
export declare type AltCond = (
  rule: Rule,
  ctx: Context,
  alt: AltMatch
) => boolean
export declare type AltModifier = (
  rule: Rule,
  ctx: Context,
  alt: AltMatch,
  next: Rule
...
export declare type AltNext = (
  rule: Rule,
  ctx: Context,
  alt: AltMatch
) => string
export declare type AltBack = (
  rule: Rule,
  ctx: Context,
  alt: AltMatch
) => number
export declare type StateAction = (rule: Rule, ctx: Context) => any
export declare type AltError = (
  rule: Rule,
  ctx: Context,
  alt: AltMatch
) => Token | undefined
export declare type ValModifier = (
  val: any,
  lex: Lex,
  cfg: Config,
  opts: Options
